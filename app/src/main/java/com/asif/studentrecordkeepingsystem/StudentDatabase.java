...
public class StudentDatabase extends SQLiteOpenHelper {
    ...
    public List<Course> extractUnenrolledAllCourses(String studentID){
        try {
            ArrayList<Course> coursesList = new ArrayList<Course>();
            SQLiteDatabase db = getWritableDatabase();
            Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_COURSE + " WHERE course_code != ( " +
    ...
    public boolean updateStudent(Student student){
        try{
            ...
            long result = dbl.update(TABLE_STUDENT,  studentValues, "std_roll_no="+student.getStd_roll_number()  , null);
