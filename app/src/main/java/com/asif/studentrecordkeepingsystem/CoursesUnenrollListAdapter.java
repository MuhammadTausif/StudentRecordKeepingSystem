...
public class CoursesUnenrollListAdapter extends ArrayAdapter<Course> {
    private Context context;
    private List<Course> courses;

    public CoursesUnenrollListAdapter(Context context, List<Course> courses) {
        super(context, R.layout.fragment_enroll_student, courses);
        this.context = context;
        this.courses = courses;
    }

    public CoursesUnenrollListAdapter(Context context, int resource) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = layoutInflater.inflate(R.layout.courses_unenrolled_list, parent, false);
